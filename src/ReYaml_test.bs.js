...
var ReYaml = require("./ReYaml.bs.js");

Jest.test("Boolean", (function (param) {
        return Jest.Expect[/* toEqual */12](/* Bool */Block.__(0, [true]), Jest.Expect[/* expect */0](ReYaml.parse("true")));
      }));

Jest.test("Boolean", (function (param) {
        return Jest.Expect[/* toEqual */12](/* Bool */Block.__(0, [false]), Jest.Expect[/* expect */0](ReYaml.parse("false")));
      }));

Jest.test("Float", (function (param) {
        return Jest.Expect[/* toEqual */12](/* Float */Block.__(1, [1]), Jest.Expect[/* expect */0](ReYaml.parse("1")));
      }));

Jest.test("String", (function (param) {
        return Jest.Expect[/* toEqual */12](/* String */Block.__(2, ["tenis"]), Jest.Expect[/* expect */0](ReYaml.parse("tenis")));
      }));
...
Jest.test("Array", (function (param) {
        return Jest.Expect[/* toEqual */12](/* Array */Block.__(3, [/* :: */[
                        ...
                        /* [] */0
                      ]]), Jest.Expect[/* expect */0](ReYaml.parse("- tenis")));
      }));
...
Jest.test("Object", (function (param) {
        return Jest.Expect[/* toEqual */12](/* Object */Block.__(4, [/* :: */[
                        ...
                        /* [] */0
                      ]]), Jest.Expect[/* expect */0](ReYaml.parse("tenis: 1")));
      }));
...
Jest.test("Stringify Object", (function (param) {
        return Jest.Expect[/* toEqual */12]("first: 1\nsecond:\n  - 1\n  - str\nthird:\n  here: 2\n", Jest.Expect[/* expect */0](ReYaml.stringify(/* Object */Block.__(4, [/* :: */[
                                /* tuple */[
                                  "first",
                                  /* Float */Block.__(1, [1])
                                ],
...
Jest.test("Comments", (function (param) {
        return Jest.Expect[/* toEqual */12]("<<: more\nsrani: 1\n", Jest.Expect[/* expect */0](ReYaml.stringify(ReYaml.parse("<<: more\n# whaat\nsrani: 1\n"))));
      }));
...
Jest.test("Only one comment yaml", (function (param) {
        return Jest.Expect[/* toEqual */12](/* Null */0, Jest.Expect[/* expect */0](ReYaml.parse("# comment")));
      }));
